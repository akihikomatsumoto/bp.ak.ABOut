...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 4.25061, 222.425842, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.780659, 170.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 92.25061, 371.092529, 50.0, 22.0 ],
					"presentation_rect" : [ 92.25061, 372.092529, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 33.25061, 371.092529, 33.0, 22.0 ],
					"presentation_rect" : [ 33.25061, 372.092529, 0.0, 0.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.25061, 319.827759, 29.5, 22.0 ],
					"presentation_rect" : [ 92.25061, 320.827759, 0.0, 0.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.25061, 319.827759, 29.5, 22.0 ],
					"presentation_rect" : [ 33.25061, 320.827759, 0.0, 0.0 ],
					"style" : "",
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 92.25061, 284.092529, 49.0, 22.0 ],
					"presentation_rect" : [ 92.25061, 285.092529, 0.0, 0.0 ],
					"style" : "",
					"text" : "delay 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.199997, 525.200012, 25.0, 25.0 ],
					"presentation_rect" : [ 31.199997, 526.200012, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -88.0, 154.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ -88.0, 116.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "< 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ -94.0, 65.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "random 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 78.76239, -43.899986, 44.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.78066, 79.500008, 44.0, 44.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
							"parameter_longname" : "AB",
							"parameter_shortname" : "AB",
							"parameter_type" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"outlinecolor" : [ 0.74902, 0.74902, 0.74902, 1.0 ],
					"patching_rect" : [ -104.74939, 222.425842, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -4.219341, 170.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 63.0, 203.996155, 70.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -45.74939, 371.092529, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -104.74939, 371.092529, 33.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -45.74939, 319.827759, 29.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -104.74939, 319.827759, 29.5, 22.0 ],
					"style" : "",
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -45.74939, 284.092529, 49.0, 22.0 ],
					"style" : "",
					"text" : "delay 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -106.800003, 525.200012, 25.0, 25.0 ],
					"style" : ""
				}
